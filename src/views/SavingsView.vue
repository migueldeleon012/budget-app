  ...
  <v-container>
    ...
    >
      <template v-slot:item.actions="{ item }">
        ...
        <v-icon size="small" @click="deleteSavings(item)"> mdi-delete </v-icon>
      </template>
    </v-data-table>
    ...
    <v-form @submit.prevent="addSavings">
      <v-row>
...
export default defineComponent({
  ...
  setup() {
    ...
    const deleteSavings = (item: SavingsOrObjectives) => {
      store.commit('deleteSavings', item.id);
    };
